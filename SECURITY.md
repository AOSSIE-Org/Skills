...
This policy applies to the **Skills Core** (`AOSSIE-Org/Skills`) repository.
...
https://github.com/AOSSIE-Org/Skills/security/advisories/new
...
We appreciate responsible disclosure and thank you for helping keep Skills Core secure and reliable.
